...
- `SYSTIMESTAMP` fonksiyonu, sistemin tarih ve saat bilgisini [`TIMESTAMP WITH TIME ZONE`]({% post_url 2025-05-18-oracle-DATE-ve-TIMESTAMP-veri-tipleri %}/#TIMESTAMP-WITH-TIME-ZONE) tipinde döner.
- Parametre almaz.
